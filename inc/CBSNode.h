...
public:
	...
	// // the following is used to comapre nodes in the bCOA* list
	// struct compare_node_by_c
	// {
	// 	bool operator()(const CBSNode* n1, const CBSNode* n2) const
	// 	{
	// 		if(n1->c_val == n2->c_val) // both n1, n2 are the same class
	// 		{
	// 				if (n1->distance_to_go == n2->distance_to_go)
	// 				{
	// 					if (n1->g_val + n1->h_val == n2->g_val + n2->h_val)
	...
	// 				return n1->distance_to_go >= n2->distance_to_go;
	// 		}
	// 		return n1->c_val; // if n1 true, then it is class2, and n2 is class1. Since they are different class.
	//
	// 	} // bool operator
	// };  // used by bCOA to compare nodes by color
	...
	// 								}
	// 								return n1->distance_to_go >= n2->distance_to_go;  // n1 > n2 if it has more conflicts
	// 						}
	...
	// the following is used to comapre nodes in the bCOA* list
	struct compare_node_by_b
	{
		bool operator()(const CBSNode* n1, const CBSNode* n2) const
		{
			if(n1->b_val == n2->b_val) // both n1, n2 are the same class
			{
					if (n1->distance_to_go == n2->distance_to_go)
					{
						if (n1->g_val + n1->h_val == n2->g_val + n2->h_val)
			...
			return n1->b_val > n2->b_val; // if n1 true, then it is class2, and n2 is class1. Since they are different class.
	...
	pairing_heap< CBSNode*, compare<CBSNode::compare_node_by_b> >::handle_type bcoa_handle;
